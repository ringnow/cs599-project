      ...
      <div id="cs599-app-frame" className="flex h-full w-full md:rounded-[32px] overflow-hidden bg-white/70 backdrop-blur-xl border border-white/60 shadow-[0_30px_70px_-15px_rgba(15,23,42,0.18)]">
        ...
        <section className="flex-1 flex overflow-hidden p-4 gap-4">
          ...
          <div className="w-[380px] xl:w-[430px] flex flex-col gap-6 overflow-y-auto pr-2">
            ...
            {activeTab === "skills" && (
              <SkillsTab
                skills={skills} rawSkills={rawSkills}
                installCode={installCode} setInstallCode={setInstallCode}
                installFilename={installFilename} setInstallFilename={setInstallFilename}
                isInstallExpanded={isInstallExpanded} setIsInstallExpanded={setIsInstallExpanded}
                setSkills={setSkills}
                showToast={showToast} fetchSkills={fetchSkills}
                installSkill={installSkill} uninstallSkill={uninstallSkill}
              />
            )}            {/* 8. TAB: 服务商管理 */}
            {activeTab === "providers" && (
              <div className="space-y-6">
